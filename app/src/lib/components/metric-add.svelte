...
<form method="POST" use:enhance class="row g-3">
	<div class="col-md-6">
		...
		<select name="metricTypeId" bind:value={selectedMetricTypeId} class="form-select" id="metricTypeId">
	...
	<div class="col-md-6">
		...
		<input type="datetime-local" name="datetime" value={format(new Date(), "yyyy-MM-dd'T'HH:mm")} class="form-control" id="datetime" />
	</div>
	<div class="col-12">
